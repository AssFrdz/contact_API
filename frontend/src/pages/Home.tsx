    ...
    <Stack spacing={4}>
      ...
      >
        <Stack spacing={2} alignItems="flex-start">
          ...
          <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 560 }}>
            Gardez vos relations organisees, acces rapides, et informations toujours a jour
            dans un tableau clair et securise.
          </Typography>
      ...
      <Stack direction={{ xs: "column", md: "row" }} spacing={2}>
        ...
        <Paper elevation={0} sx={{ p: 2.5, flex: 1, borderRadius: 3 }}>
          ...
          <Typography color="text.secondary">Derniere mise a jour</Typography>
        </Paper>
        <Paper elevation={0} sx={{ p: 2.5, flex: 1, borderRadius: 3 }}>
          <Typography variant="overline" color="text.secondary">
            Etat
